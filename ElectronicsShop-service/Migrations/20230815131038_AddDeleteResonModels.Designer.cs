...
namespace ElectronicsShop_service.Migrations
{
    ...
    [Migration("20230815131038_AddDeleteResonModels")]
    partial class AddDeleteResonModels
    {
            ...
            modelBuilder.Entity("ElectronicsShop_service.Models.Shop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a135e70f-f393-4dbb-bb20-bf5d1de95123"),
                            CreationDate = new DateTime(2023, 8, 15, 15, 10, 37, 791, DateTimeKind.Local).AddTicks(5368),
                            Password = "Reda12@",
                            Role = "Admin",
                            UserName = "reda",
                            WhatToSee = "shop1"
