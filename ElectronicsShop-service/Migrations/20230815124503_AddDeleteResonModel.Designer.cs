...
namespace ElectronicsShop_service.Migrations
{
    ...
    [Migration("20230815124503_AddDeleteResonModel")]
    partial class AddDeleteResonModel
    {
            ...
            modelBuilder.Entity("ElectronicsShop_service.Models.Shop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("10f456d7-d758-45fc-91ed-742e160419bf"),
                            CreationDate = new DateTime(2023, 8, 15, 14, 45, 3, 364, DateTimeKind.Local).AddTicks(8707),
                            Password = "Reda12@",
                            Role = "Admin",
                            UserName = "reda",
                            WhatToSee = "shop1"
